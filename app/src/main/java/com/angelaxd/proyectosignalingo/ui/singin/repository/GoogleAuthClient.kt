package com.angelaxd.proyectosignalingo.ui.singin.repository
/*
...
import com.angelaxd.proyectosignalingo.data.User
        ...
        return BeginSignInRequest.Builder()
            .setGoogleIdTokenRequestOptions(
                GoogleIdTokenRequestOptions.builder()
                    .setSupported(true)
                    .setFilterByAuthorizedAccounts(false) //si es true jala las cuentas que uan no estan logeadas
